  ...
  rootElement.innerHTML = `
		<main class="feed-page bg-slate-50">
			<header class="detail-topbar create-topbar">
				<button class="back-button border-white/75 bg-white/45 backdrop-blur-md" id="create-cancel-top" type="button">Cancel</button>
				<h1 class="feed-title">Create Post</h1>
			</header>

      <section class="post-detail-card max-w-2xl border-white/70 bg-white/35 shadow-lg shadow-slate-900/10 backdrop-blur-xl" aria-labelledby="create-post-title">
				...
				<form id="create-post-form" class="create-post-form">
					...
					<div class="create-form-actions">
						<button class="back-button border-white/75 bg-white/45 backdrop-blur-md" id="create-cancel-bottom" type="button">Cancel</button>
            <button class="submit-button create-submit-button border-white/70 bg-white/35 text-slate-900" id="create-submit" type="submit">Create Post</button>
					</div>
